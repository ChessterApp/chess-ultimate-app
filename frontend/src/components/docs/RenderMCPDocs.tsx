    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        ...
        <AccordionDetails>
          ...
          <Link
            href="https://smithery.ai/server/@jalpp/chessempire-mcp"
            target="_blank"
            rel="noopener"
          >
            Visit Smithery Page →
          ...
          <List>
            <ListItem>
              ...
              <ListItemText
                ...
                secondary={
                  <Link
                    href="https://github.com/jalpp/chessempire-mcp/releases"
                    target="_blank"
                    rel="noopener"
                  >
            ...
            <ListItem>
              ...
              <ListItemText primary="4. Select the chessempire-mcp.mcpb file" />
            </ListItem>
            <ListItem>
              <ListItemIcon>
                <CheckCircle color="primary" />
      ...
      >
        ...
        <AccordionDetails>
          ...
          <CodeBlock
            code={`git clone https://github.com/jalpp/chessempire-mcp.git
cd chessempire-mcp
npm install
npm run build:mcp`}
          />
  ...
  "mcpServers": {
    "chessempire-mcp": {
      "command": "node",
      "args": ["/absolute/path/to/chessempire-mcp/build/runner/stdio.js"]
    }
  }
}`}
          />
  ...
  "mcpServers": {
    "chessempire-mcp": {
      "command": "node",
      "args": ["C:\\\\absolute\\\\path\\\\to\\\\chessempire-mcp\\\\build\\\\runner\\\\stdio.js"]
    }
  }
}`}
          />
