        ...
        <div className="mt-6 border-t border-gray-100 pt-6">
          ...
          >
            <span className="flex items-center justify-between gap-3">
              <span className="font-bold uppercase tracking-wide whitespace-nowrap text-[clamp(0.75rem,3.8vw,1rem)]">
                {trialLoading ? t('verifying') : t('trialCta.title')}
              </span>
              <span className="shrink-0 whitespace-nowrap rounded-full bg-white/25 px-3 py-1 font-bold uppercase tracking-wide text-[clamp(0.5625rem,2.8vw,0.75rem)]">
                {t('trialCta.badge')}
              </span>
            </span>
            <span className="block text-sm text-white/90 mt-1">{t('trialCta.subtitle')}</span>
          </button>
        </div>
      )}
    </>
