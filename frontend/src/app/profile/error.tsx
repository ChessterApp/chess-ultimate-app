...
export default function Error({
  ...
  useEffect(() => {
    ...
    reportError(error, 'component', { page: 'profile', digest: error.digest });
  }, [error]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-50 to-white p-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Couldn&apos;t load your profile</h2>
        <p className="text-gray-500 mb-6">
          Something went wrong loading your profile. Let&apos;s try again.
        </p>
