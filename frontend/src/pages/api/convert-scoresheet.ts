...
import { checkVisionRateLimit, CONVERT_SCORESHEET_LIMITS } from '@/lib/vision-rate-limit';
...
export default async function handler(
  ...
  const limit = checkVisionRateLimit(req, 'convert-scoresheet', CONVERT_SCORESHEET_LIMITS);
  if (!limit.allowed) {
